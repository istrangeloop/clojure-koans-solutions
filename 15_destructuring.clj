...
(defn person [[first-name last-name & aliases]]
  (str first-name " " last-name (apply str (for [alias aliases] (str " aka " alias)))))

(defn mail-address [address]
...
(meditations
  ...
  (= "Test Testerson, 123 Test Lane, Testerville, TX"
     (apply str (person ["Test" "Testerson"]) ", " (mail-address test-address)))
  )